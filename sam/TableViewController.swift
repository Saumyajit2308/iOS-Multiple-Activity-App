...
class TableViewController: UITableViewController, UISearchBarDelegate{
  ...
  var inSearchMode = false
    ...
    override func viewDidLoad() {
        ...
        //self.searchBar.setGradientBackground(colorOne: Colors.orange, colorTwo: Colors.brightOrange)
        
        self.tableView.backgroundView = UIImageView(image: UIImage(named: "G.jpg"))
